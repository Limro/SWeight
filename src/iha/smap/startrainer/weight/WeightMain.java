...
public class WeightMain extends Activity implements AdapterView.OnItemClickListener
{
    ...
    private void ShowKeyBoardOnStartup()
	{
		...
		InputMethodManager imm = (InputMethodManager)getSystemService(
			...
			imm.showSoftInput(findViewById(R.id.WeightEntry), 0);
	}
	...
	private void HideKeyboard()
	{
		...
		EditText t = (EditText)findViewById(R.id.WeightEntry);
	...
	{
		final EditText t = (EditText) findViewById(R.id.WeightEntry);
